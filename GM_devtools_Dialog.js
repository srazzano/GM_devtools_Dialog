...
// @homepageURL https://github.com/srazzano/GM_devtools_Dialog
// @downloadURL https://raw.githubusercontent.com/srazzano/GM_devtools_Dialog/master/GM_devtools_Dialog.js
// @updateURL   https://raw.githubusercontent.com/srazzano/GM_devtools_Dialog/master/GM_devtools_Dialog.js
...
#devtools-wrapper .dialog .dialog-title {border-radius: 4px !important; background-color: #444 !important; color: #eee !important; height: 22px !important; padding: 0 !important; text-align: center !important}\
...
#devtools-wrapper .dialog .dialog-footer button {background: linear-gradient(#555, #222) !important; border: 1px solid #333 !important; box-shadow: 0 0 1px #666 inset !important; border-radius: 4px !important; color: #FFF !important; cursor: pointer !important; display: inline-block !important; height: 25px !important; margin-left: 2px !important; margin-right: 2px !important; padding: 2px 5px 1px !important}\
...
#devtools-wrapper .dialog .progress-bar {border-radius: 4px !important; background-color: #fafafa !important; border: 1px solid #ddd !important}\
#devtools-wrapper .dialog .progress-bar-inner {border-radius: 4px !important; background-color: #444 !important}\
    ...
    'input': {
      ...
      replacement: function (tag) {
        ...
        switch (tag.attributes.type) {
          ...
          case 'radio':
            try {
              options = devtools.JSON.parse(tag.attributes.options);
